...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_service_auth_service__ = __webpack_require__(190);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SingupPage = (function () {
    ...
    function SingupPage(navCtrl, authServiceProvider) {
        ...
        this.userData = { "username": "", "password": "", "email": "", "name": "", "city": "" };
        this.ciudad = [];
    ...
    SingupPage.prototype.ionViewDidLoad = function () {
        ...
        // var usStates = new UsaStates();
        // console.log(usStates.states);
        var someArray = __WEBPACK_IMPORTED_MODULE_2_cities___default.a.findByState('NJ');
        ...
        console.log(__WEBPACK_IMPORTED_MODULE_3_states_utils___default.a.getStates());
    };
