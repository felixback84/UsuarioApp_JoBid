...
function setupServer(env, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.livereload) {
            const { createLiveReloadServer } = yield Promise.resolve().then(function () { return require('../livereload'); });
...
function createHttpServer(env, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const serveIndex = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (options.livereload) {
                const { injectLiveReloadScript } = yield Promise.resolve().then(function () { return require('../livereload'); });
